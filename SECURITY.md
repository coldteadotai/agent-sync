...
5. The published package has zero runtime dependencies and is built from this repository by the release maintainer. Publishing runs through the maintainer's npm account with two-factor authentication; no automation token exists. CI-based publishing with provenance attestation is the planned next step and will supersede this line when it lands.
